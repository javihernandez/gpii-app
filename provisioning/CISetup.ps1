<#
  This script pulls the necessary bits from gpii-windows to setup CouchDB.

  It is only intended to be used in the context of github's ci
...
$windowsBootstrapURL = "https://raw.githubusercontent.com/javihernandez/windows/0e050b79fdc44708e9c686c67a72cbb3865cac03/provisioning"
try {
